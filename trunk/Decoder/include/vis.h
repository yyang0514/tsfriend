...
static _inline void vis_set_gsr(unsigned int _val)
{
...
static _inline void *vis_alignaddr(void *_ptr)
{
...
static _inline void vis_alignaddr_g0(void *_ptr)
{
	register void *ptr asm("g1");
...
static _inline void *vis_alignaddrl(void *_ptr)
{
	register void *ptr asm("g1");
...
static _inline void vis_alignaddrl_g0(void *_ptr)
{
	register void *ptr asm("g1");
